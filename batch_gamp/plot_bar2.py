...
if __name__ == '__main__':
    ...
    filepath2 = r"C:\Users\LZ\Desktop\isb\con11.csv"
    config = {
    ...
    plt.ylabel('收敛时间[min]', fontsize='x-large')
    # plt.ylabel('Positioning Accuracy[cm]')
    #plt.xlabel('Site', fontsize='x-large')
    plt.xlabel('站点', fontsize='x-large')
    plt.ylim([0, 115])
    #plt.ylim([0, 45])
    #plt.text(-1, 40, 'ISB OFF', fontsize='xx-large')
    plt.text(-1,95,'ISB OFF',fontsize='xx-large')
    #plt.ylim([0, 120])
    #plt.tight_layout()
    ...
    plt.xlabel('站点',fontsize='x-large')
    plt.ylim([0,115])
    plt.text(-1, 95, 'ISB ON', fontsize='xx-large')
    #plt.ylim([0, 45])
    #plt.text(-1, 40, 'ISB ON', fontsize='xx-large')
    plt.tight_layout()
