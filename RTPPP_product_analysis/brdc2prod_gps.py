...
from readfile import readbrdc, readssrc2, readantex
from writefile import *
from sat_apc import satantoff
...
def process(ephmode, filepath, navfile, ssrcfile, atxfile):
    init_global()  # 全局变量初始化
...
if __name__ == '__main__':
    ...
    for ssrc in ssrclist:
        ...
        process(ephmode, output_filepath, navfile, ssrcfile, atxfile)
