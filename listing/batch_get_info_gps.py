...
if __name__ == '__main__':
    filepath = "D:\\paperdata\\2021\\182\\daily"  # 存放原始观测文件的文件夹
    wlistpath = 'C:\\Users\\LZ\\Desktop\\BDS_SITE_INFO\\site_gps.list'   # 站点列表文件
    writepath = 'C:\\Users\\LZ\\Desktop\\BDS_SITE_INFO\\gps_site_type1.info'  # 输出文件
